...
# =====================================================================
# Helper: Load name list (single-column CSV)
# =====================================================================
def load_list(path):
    ...
    s = s[s.str.match(r"^[A-Za-z\-\'. ]+$")]     # only valid name chars
...
# =====================================================================
def generate_synthetic_customers(config, save_customer_csv=False, out_cust="SyntheticCustomers.csv"):
